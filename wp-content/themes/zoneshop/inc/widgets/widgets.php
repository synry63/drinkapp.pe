...
include_once( TP_THEME_DIR . '/inc/widgets/our-team/our-team.php' );
include_once( TP_THEME_DIR . '/inc/widgets/posts-display/posts-display.php' );
include_once( TP_THEME_DIR . '/inc/widgets/progress-bar/progress-bar.php' );
include_once( TP_THEME_DIR . '/inc/widgets/progress-circle/progress-circle.php' );
include_once( TP_THEME_DIR . '/inc/widgets/recent-post/recent-post.php' );
include_once( TP_THEME_DIR . '/inc/widgets/sale-off/sale-off.php' );
include_once( TP_THEME_DIR . '/inc/widgets/search/search.php' );
include_once( TP_THEME_DIR . '/inc/widgets/shop-by-cat/shop-by-cat.php' );
...
include_once( TP_THEME_DIR . '/inc/widgets/tab/tab.php' );
...
include_once( TP_THEME_DIR . '/inc/widgets/wc-product-showcase/wc-product-showcase.php' );
include_once( TP_THEME_DIR . '/inc/widgets/wc-product-slider/wc-product-slider.php' );
include_once( TP_THEME_DIR . '/inc/widgets/wc-sub-category/wc-sub-category.php' );
