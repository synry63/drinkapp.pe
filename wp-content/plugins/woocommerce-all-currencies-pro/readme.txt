=== All Currencies for WooCommerce Pro ===
...
Plugin extends the WooCommerce by adding all world currencies.

== Description ==

The plugin extends the WooCommerce e-commerce plugin by adding all world currencies. There is also an option to modify currency symbol.
...
= More =
* Visit the [All Currencies for WooCommerce Pro plugin page](http://coder.fm/items/woocommerce-all-currencies/)

== Installation ==

1. Upload the entire 'woocommerce-all-currencies-pro' folder to the '/wp-content/plugins/' directory
...
Yes. Just go to "WooCommerce > Settings > Currencies Pro".
