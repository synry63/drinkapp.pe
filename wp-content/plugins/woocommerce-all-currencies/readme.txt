...
= More =
* Visit the *All Currencies for WooCommerce* plugin page at http://coder.fm/items/woocommerce-all-currencies/
...
You need [All Currencies for WooCommerce Pro plugin](http://coder.fm/items/woocommerce-all-currencies/) to change these settings.
